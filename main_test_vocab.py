...
def testing(data_path, device, model,entity_id):
    model.eval()
...
test_data_path = "./Data/MetaQA/1-hop/vanilla/qa_test.txt"
...
answers, accuracy, hit5, hit10, lend, Recall1, Recall3, Recall5, Recall10, Pr1, Pr3, Pr5, Pr10= testing(test_data_path, device, model, entity_id)
